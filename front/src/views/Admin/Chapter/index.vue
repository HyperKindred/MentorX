    ...
    <div class="Main">
            ...
            <div class="chapter-list">
                <el-space direction="vertical" fill>
                    <div class="chapter-item" v-for="chapter in chapters" :key="chapter.id">
                        <el-button type="default" class="chapter-btn" @click="handleChapterClick(chapter)">
                            {{ chapter.name }}
                        </el-button>
        ...
        <div class="content-area" v-if="selectedChapter">
            ...
            <div class="chapter-content">
                <el-input v-if="isEditing" type="textarea" v-model="editedContent" rows="20" resize="none" />
